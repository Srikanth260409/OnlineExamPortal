...
def graph_view(request):
    ...
    return render(request, 'exam/graph.html', {'data': data})
...
def plot_graph(request):
    ...
    students = [result.student.name for result in results]
    ...
    return render(request, 'graph_stu.html', {'graph_url': 'data:image/png;base64,' + graph_url})
