...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': '0852',
        'HOST': 'localhost',  # Or the hostname/address of your PostgreSQL server
...
EMAIL_PORT = 587  # Port for your email provider
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'satyanukala.24@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'Satyam321@'  # Your email password
DEFAULT_FROM_EMAIL = 'satyanukala.24@gmail.com'  # Sender's email address
